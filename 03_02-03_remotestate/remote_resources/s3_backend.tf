...
# S3 BUCKET
# //////////////////////////////
resource "aws_s3_bucket" "redrkv-tfremotestate" {
...
resource "aws_s3_bucket_public_access_block" "redrkv-tfremotestate" {
  bucket = aws_s3_bucket.redrkv-tfremotestate.id
